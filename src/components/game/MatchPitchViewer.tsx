...
function createEngine(deps: EngineDeps) {
  ...
  function publish(sample: PlanSample, force: boolean) {
    ...
    const report = `${revealed}:${complete}`;
  ...
  return (
    ...
    >      <div className="mb-2 flex items-center justify-between gap-2">
      ...
      >
        ...
        {renderSide(engine, activeUserLineup, "us", activeAction, expanded)}
        {renderSide(engine, activeOpponentLineup, "them", activeAction, expanded)}
