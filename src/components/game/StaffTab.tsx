...
export function StaffCard({state,staff,onAction,onRenew,action,affordable=true,terms}:{state:GameState;staff:Staff;onAction:()=>void;onRenew?:()=>void;action:"hire"|"release";affordable?:boolean;terms?:ReturnType<typeof staffJoinTermsForState>}){
